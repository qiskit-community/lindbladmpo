...
class LindbladMPOSolverModel(unittest.TestCase):
    ...
    def test_3Q_two_solvers(self):
        ...
        solver_params = {
            ...
            "init_cz_gates": [(0, 2)],
            "output_files_prefix": s_output_path + "test_3Q_two_solvers_1",
            "1q_components": ["X", "Y", "Z"],
            "2q_components": ["XY", "XZ", "ZZ"],
        }
        solver1 = LindbladMPOSolver(solver_params, s_cygwin_path, s_solver_path)
        solver1.solve()
        solver_params.update({"output_files_prefix": s_output_path + "test_3Q_two_solvers_2"})
        solver2 = LindbladMatrixSolver(solver_params)
        solver2.solve()
