...
h_z_amp = (
    10.0  # Qubit frequencies will be random (uniformly distributed) in the interval
)
...
g_0 = 0.1  # Energy relaxation rate, uniform for all qubits
g_2 = 0.1  # Decoherence (dephasing) rate, uniform for all qubits
J = 1.0 * 2 * np.pi  # XY coupling coefficient, uniform for all qubit bonds.
